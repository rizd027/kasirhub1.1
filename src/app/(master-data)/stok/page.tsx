                  ...
                  <div className="flex flex-col px-6 py-5 gap-5">
                    ...
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex items-center gap-4 min-w-0">
                        <div className="h-14 w-14 shrink-0 rounded-lg bg-white overflow-hidden flex items-center justify-center border border-slate-100 shadow-sm transition-transform duration-300">
                          {item.image_url ? (
                      ...
                      <div className="shrink-0">
                        {!isEditing ? (
                          <DropdownMenu>
                            <DropdownMenuTrigger className="h-12 w-12 rounded-lg bg-slate-100 text-slate-600 hover:text-indigo-600 hover:bg-white border border-slate-200 transition-all flex items-center justify-center shadow-sm">
                          ...
                          <div className="flex flex-col gap-1">
                            <Button 
                              size="sm" 
                              className={cn(
                                "h-10 px-4 font-black text-xs rounded-lg shadow-lg transition-all active:scale-95",
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      {/* Store Stock */}
                      <div className={cn("p-4 rounded-lg border transition-colors", isEditing ? "bg-white border-indigo-200" : "bg-slate-50 border-slate-100")}>
                        ...
                        {isEditing ? (
                          <div className="flex flex-col gap-2">
                            <Input
                              type="number"
                              min={0}
                              className="h-10 text-center font-bold text-lg rounded-lg border-indigo-100 focus-visible:ring-indigo-500 bg-white"
