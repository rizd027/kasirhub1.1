...
const settingMenus = [
  ...
  { title: 'Produk, Bahan & Bundling', desc: 'Manajemen katalog dan inventaris', icon: Package, href: '/produk', protected: true },
  { title: 'Stok', desc: 'Kelola stok gudang dan stok toko', icon: Boxes, href: '/stok', protected: true },
  ...
  { title: 'PIN', desc: 'PIN Keamanan untuk membatasi ubah/hapus nota', icon: Key, href: '/pengaturan/pin', protected: false },
  { title: 'Preferensi', desc: 'Mengubah format dan label', icon: LayoutGrid, href: '/pengaturan/preferensi', protected: true },
  { title: 'Account', desc: 'Login/Register untuk sinkronisasi database', icon: UserCircle2, href: '/pengaturan/account', protected: false },
  { title: 'Penyimpanan Data', desc: 'Backup otomatis ke Google Drive', icon: Database, href: '/pengaturan/penyimpanan', protected: true },
  { title: 'Export Import Data', desc: 'Transfer data antar perangkat', icon: ArrowUpDown, href: '/pengaturan/export-import', protected: true },
  { title: 'Bantuan', desc: 'Panduan penggunaan', icon: HelpCircle, href: '/pengaturan/bantuan', protected: false },
];
        ...
        <div className="flex flex-col min-w-0">
          ...
          {filteredMenus.map((menu) => {
            ...
            return (
              <Link
                ...
                className="flex items-center gap-4 p-4 hover:bg-slate-50 active:bg-slate-100/80 transition-all rounded-lg group border border-transparent hover:border-slate-100"
              >
                <div className="flex items-center justify-center w-11 h-11 rounded-lg bg-indigo-50 text-indigo-600 group-hover:scale-110 transition-transform duration-300 shadow-sm border border-indigo-100/50">
          ...
          <div className="px-6 py-4 mt-2">
            <button 
              ...
              className="w-full flex items-center justify-center gap-3 h-14 rounded-lg bg-red-50 hover:bg-red-100 text-red-600 transition-all active:scale-[0.98] border border-red-100"
            >
